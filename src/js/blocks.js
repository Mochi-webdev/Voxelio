...
// FIXED STYLE BLOCK (FieldColor statt FieldColour)
Blockly.Blocks['style_ui'] = {
  init: function() {
    // Hilfsfunktion um das Farbfeld zu finden
    const createColorField = (defaultColor) => {
      if (Blockly.fieldColour && Blockly.fieldColour.FieldColour) {
        ...
        // Fallback: Normales Textfeld, falls das Plugin gar nicht lädt
...
// Block: UI Hover-Effekt einstellen
